...
export const ALBUMS: Album[] = [
  new Album('Pules', 'Pink Floyd','A live album by the English progressive rocck band originally released in 1995, on the label EMI in the United Kingdom', 1),
  new Album('Funhouse','The Stooges','The second  album from the American rock band, released in 1970 by Elektra Records.', 3),
